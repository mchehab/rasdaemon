            ...
            case $words[1] in
                ...
                database|db)
                    _arguments \
                        ...
                        '(-S --summary --table-summary -C --count -E --errors-per-table -L --list-tables -D --describe -I --create-index)'{-e,--errors}'[display detailed error records]' \
                        '(-e --errors --table-summary -C --count -E --errors-per-table -L --list-tables -D --describe -I --create-index)'{-S,--summary}'[display table-aware event summaries]' \
                        '(-e --errors -S --summary -C --count -E --errors-per-table -L --list-tables -D --describe -I --create-index)--table-summary[display event counts by hostname and table]' \
                        '(-e --errors -S --summary --table-summary -E --errors-per-table -L --list-tables -D --describe -I --create-index)'{-C,--count}'[count matching events]' \
                        '(-e --errors -S --summary --table-summary -C --count -L --list-tables -D --describe -I --create-index)'{-E,--errors-per-table}'[count matching errors in each non-empty event table]' \
                        '(-e --errors -S --summary --table-summary -C --count -E --errors-per-table -D --describe -I --create-index)'{-L,--list-tables}'[list discovered event tables]' \
                        '(-e --errors -S --summary --table-summary -C --count -E --errors-per-table -L --list-tables -I --create-index)'{-D,--describe}'[describe selected event table fields]' \
                        '(-e --errors -S --summary --table-summary -C --count -E --errors-per-table -L --list-tables -D --describe)'{-I,--create-index}'[create missing indexes and exit]' \
                        ...
                        '*'{-w,--where}'=[require a comparison or OR expression]:filter:' \
                        '--module=[select a module or submodule case-insensitively]:module:' \
                        ...
                        '--json[write a versioned JSON document]'
                    ;;
            esac
            ;;
    esac
