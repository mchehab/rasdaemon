...
static const struct db_fields jm_payload0_event_fields[] = {
	...
	{ .name = "subsystem",			.type = DB_TYPE_TEXT },
	{ .name = "module",			.type = DB_TYPE_TEXT },
	{ .name = "module_id",			.type = DB_TYPE_INT32 },
	{ .name = "sub_module",			.type = DB_TYPE_TEXT },
	{ .name = "submodule_id",		.type = DB_TYPE_INT32 },
	{ .name = "dev",			.type = DB_TYPE_TEXT },
	{ .name = "dev_id",			.type = DB_TYPE_INT32 },
