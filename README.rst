...
+---------------------+----------------+------------------------+------------------------+------------------------+
| Test type           | Scope          | PASS                   | FAIL                   | SKIP                   |
+=====================+================+========================+========================+========================+
| `Functional tests`_ | Kernel         | |func-kernel-pass|     | |func-kernel-fail|     | |func-kernel-skip|     |
|                     +----------------+------------------------+------------------------+------------------------+
|                     | RAS Daemon     | |func-rasdaemon-pass|  | |func-rasdaemon-fail|  | |func-rasdaemon-skip|  |
+---------------------+----------------+------------------------+------------------------+------------------------+
